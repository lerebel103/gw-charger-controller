...
ENTITIES: list[dict[str, Any]] = [
    ...
    _number(
        "ev_charger_solar_battery_max_power",
        "Solar Battery Max Charge Power",
        "solar_battery_max_power",
        1380,
        11000,
        100,
        "W",
...
_COMMAND_MAP: dict[str, tuple[str, str]] = {
    ...
    f"{_PREFIX}/number/solar_battery_max_power/set": ("solar_battery_max_charge_power_w", "float"),
...
_NUMBER_RANGES: dict[str, tuple[float, float]] = {
    ...
    "solar_battery_max_charge_power_w": (1380, 11000),
...
class MQTTClient:
    ...
    async def _publish_config_state(self) -> None:
        ...
        pairs: list[tuple[str, str]] = [
            ...
            (f"{_PREFIX}/number/solar_battery_max_power/state", str(s.solar_battery_max_charge_power_w)),
