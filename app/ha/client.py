...
class MQTTClient:
    ...
    async def _publish_config_state(self) -> None:
        ...
        pairs: list[tuple[str, str]] = [
            ...
            (f"{_PREFIX}/number/eco_day_grid_export_charge_start/state", str(s.eco_day_grid_export_charge_start_w)),
            (f"{_PREFIX}/number/eco_day_min_batt_soc/state", str(s.eco_day_min_solar_battery_soc_pct)),
            (f"{_PREFIX}/number/eco_day_battery_full/state", str(s.eco_day_solar_battery_full_pct)),
            (f"{_PREFIX}/number/eco_day_battery_full_exit/state", str(s.eco_day_solar_battery_full_exit_pct)),
        ...
        while True:
            try:
                async with aiomqtt.Client(
                    ...
                    _throttle.clear("mqtt_publish_fail")
