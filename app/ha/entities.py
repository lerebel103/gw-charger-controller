...
ENTITIES: list[dict[str, Any]] = [
    ...
    _sensor(
        "ev_charger_l1_voltage_drop",
        "L1 Voltage Drop %",
        "l1_voltage_drop_perc",
        "%",
        None,
        "measurement",
        "diagnostic",
    ...
    _sensor(
        "ev_charger_l2_voltage_drop",
        "L2 Voltage Drop %",
        "l2_voltage_drop_perc",
        "%",
        None,
        "measurement",
        "diagnostic",
    ...
    _sensor(
        "ev_charger_l3_voltage_drop",
        "L3 Voltage Drop %",
        "l3_voltage_drop_perc",
        "%",
        None,
        "measurement",
        "diagnostic",
    ...
    _sensor(
        "ev_charger_l1_breaker_headroom",
        "L1 Breaker Headroom",
        "l1_breaker_headroom",
        "%",
        None,
    ...
    _sensor(
        "ev_charger_l2_breaker_headroom",
        "L2 Breaker Headroom",
        "l2_breaker_headroom",
        "%",
        None,
    ...
    _sensor(
        "ev_charger_l3_breaker_headroom",
        "L3 Breaker Headroom",
        "l3_breaker_headroom",
        "%",
        None,
    ...
    _sensor("ev_charger_grid_current_l1", "Grid Current L1", "grid_current_l1", "A", "current", "measurement"),
    _sensor("ev_charger_grid_current_l2", "Grid Current L2", "grid_current_l2", "A", "current", "measurement"),
    _sensor("ev_charger_grid_current_l3", "Grid Current L3", "grid_current_l3", "A", "current", "measurement"),
    ...
    _number(
        "ev_charger_eco_day_grid_export_charge_start",
        "Eco Day Grid Export Charge Start",
        "eco_day_grid_export_charge_start",
        -5000,
        -100,
        100,
        "W",
    ),
    _number("ev_charger_eco_day_min_batt_soc", "Eco Day Min Solar Batt SOC", "eco_day_min_batt_soc", 0, 100, 1, "%"),
    _number("ev_charger_eco_day_battery_full", "Eco Day Solar Batt Full SOC", "eco_day_battery_full", 80, 100, 1, "%"),
    _number(
        "ev_charger_eco_day_battery_full_exit",
        "Eco Day Solar Batt Full Exit SOC",
        "eco_day_battery_full_exit",
        0,
        100,
        1,
        "%",
    ...
    _number(
        "ev_charger_eco_day_solar_batt_charge_start",
        "Eco Day Solar Batt Charge Start",
        "eco_day_solar_batt_charge_start",
        2000,
        8000,
        100,
        "W",
    ...
    _number("ev_charger_grid_breaker_limit", "Grid Breaker Limit", "grid_breaker_limit", 10, 100, 1, "A"),
